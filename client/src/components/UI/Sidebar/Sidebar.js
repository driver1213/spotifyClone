...
import radioIcon from '../../../assets/radio.svg';
import micoIcon from '../../../assets/casette.svg';
import jackIcon from '../../../assets/jack.svg';
  ...
  return (
    ...
    <Sidebar>
      ...
      <SidebarSection>
        <SidebarTitle>Browse Music</SidebarTitle>
        <SidebarMenu>
          <SidebarMenuLink to="/dashboard">
            <SidebarMenuItem>
              <SidebarMenuItemIcon src={jackIcon} />
              Dashboard
            </SidebarMenuItem>
          </SidebarMenuLink>
          <SidebarMenuLink to="/profile">
          ...
          <SidebarMenuLink to="/discover" >
            <SidebarMenuItem>
              <SidebarMenuItemIcon src={micoIcon} />Discover
          </SidebarMenuItem>
          </SidebarMenuLink>
          <SidebarMenuLink to="#" >
            <SidebarMenuItem>
              <SidebarMenuItemIcon src={radioIcon} />Radio
          </SidebarMenuItem>
          </SidebarMenuLink>
        </SidebarMenu>
      </SidebarSection>
      <a href='http://localhost:8888' style={{ fontSize: 20 }}> Logout </a>
